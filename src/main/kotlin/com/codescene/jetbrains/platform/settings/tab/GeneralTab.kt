...
import com.codescene.jetbrains.core.util.Constants.SUPPORT_URL
import com.codescene.jetbrains.core.util.Constants.TERMS_AND_CONDITIONS_URL
...
import com.codescene.jetbrains.platform.util.PlatformConstants.GREEN
import com.codescene.jetbrains.platform.util.PlatformConstants.RED
...
class GeneralTab : Configurable {
    ...
    private fun getStatusButton(): JButton {
        status = CodeSceneGlobalSettingsStore.getInstance().currentState().aceStatus
