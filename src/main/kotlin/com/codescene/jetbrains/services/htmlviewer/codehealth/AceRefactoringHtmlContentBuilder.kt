...
class AceRefactoringHtmlContentBuilder : HtmlContentBuilder() {
    ...
    override fun summary(confidence: Confidence) =
        apply {
    ...
    override fun reasons(refactoringResult: RefactorResponse) =
        apply {
    ...
    override fun code(refactoredFunction: RefactoredFunction) =
        apply {
