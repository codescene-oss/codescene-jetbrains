    ...
    fun setUp() {
        val mockApplication =
            mockk<Application> {
                ...
                every { getService(CodeSceneGlobalSettingsStore::class.java).currentState() } returns mockk()
                every {
                    getService(
                        CodeSceneGlobalSettingsStore::class.java,
                    ).currentState().excludeGitignoreFiles
                } returns true
